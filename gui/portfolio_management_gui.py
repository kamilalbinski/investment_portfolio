...
from utils.database_setup import get_temporary_portfolios_list, get_portfolio_over_time
...
class PortfolioManager:
    ...
    def setup_control_widgets(self):
        ...
        self.portfolio_names = get_temporary_portfolios_list()
        ...
        self.portfolio_label = ctk.CTkLabel(self.portfolio_selection_frame, text="Portfolio ID:")
    ...
    def save_table_to_csv(self):
        ...
        portfolio_id = self.portfolio_combobox.get()
        if not portfolio_id:
            portfolio_id = None
    ...
    def on_selection_change(self):
        ...
        self.append_log(f"Portfolio changed to: {self.portfolio_combobox.get()}")
